...
module raycaster_engine (
    ...
    // Added explicit WAIT states to fix 100MHz Timing Violations
    enum logic [4:0] {
        INIT, DRAW_BG,
        ...
        if (reset) begin
            ...
            case (state)
                ...
                CALC_RAY_MUL: begin
                    ...
                    state          <= WAIT_RAY_MUL; // Timing buffer
                end
                ...
                SETUP_STEP_MUL: begin
                    ...
                    state <= WAIT_STEP_MUL; // Timing buffer
                end
                ...
                DDA_BRAM_WAIT1: begin
                    state <= DDA_BRAM_WAIT2; // BRAM Pipeline Safety
                end
                ...
                CALC_HEIGHT_MUL: begin
                    ...
                    state <= WAIT_HEIGHT_MUL; // Timing Buffer
                end
                ...
                DRAW_SEG: begin
                    ...
                    // Re-enabled Outline logic to make edges pop smoothly
                    if (hit_fraction < 16'h0300 || hit_fraction > 16'hFD00 ||
                        screen_y == drawSegStart || screen_y == drawSegEnd) begin
                        wall_color = 4'h1; // Dark edge outline
                    end
