            ...
            case (state)
                ...
                DRAW_BG: begin
                    ...
                    if (screen_y == 8'd239) begin
                        // Perfectly smooth linear ray fanning
                ...
                CALC_HEIGHT_ADD: begin
                    ...
                    // Fixed explicitly to prevent SV from making the part-select unsigned
                    if (side == 0)
                ...
                DRAW_SEG: begin
                    ...
                    // Pure BRAM colors and distance shading. Outlines removed.
