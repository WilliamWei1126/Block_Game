        ...
        if (reset) begin
            ...
            case (state)
                ...
                WAIT_HEIGHT: begin
                    div_valid_in <= 1'b0;
                    if (div_valid_out) begin
                        // GRABBING [55:24] TO KEEP 8 BITS OF DECIMAL FRACTION
                        saved_line_height <= div_result[55:24]; 
                ...
                CALC_HEIGHT_ADD: begin
                    ...
                    // NEW 24.8 FIXED POINT MATH VARIABLES
                    ...
                    // 1. Shift out decimals (+128 for perfect rounding) to get the floor line
                    unit_height = (saved_line_height + 32'd128) >>> 8;
                
                    // 2. Multiply height USING the decimals to prevent amplification
                    total_height_fp = saved_line_height * $signed({29'd0, hit_height});
                    
                    // 3. Shift out decimals to get the final wall size
